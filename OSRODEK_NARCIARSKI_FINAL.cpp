...
class Logowanie
{
	...
	int sprawdzanie_BD()
	{
        ...
        cout<<"       WprowadŸ poprawne dane       "<<endl;
		Logowanie l1;
		l1.wprowadz_dane();
		l1.sprawdzanie_BD();
        return 0;
...
class dane
{
	...
	int sprawdzanie_karnet()
	{
		...
		cout<<endl<<"Nie ma takiego uzytkownika w systemie"<<endl;
		return 0;
		koniec_karnet:
        cout<<karnet;
        plik.close();
...
class Karnet: public Zjazdowy, public Czasowy, public Przedluz_waznosc, public platnosc
{
    ...
    void kup_karnet()
    {
        ...
        else if( rodzaj_karnetu == "godzinny")
		{
			...
			cout<<endl<<" Na ile godzin wykupiæ karnet?"<< endl;
            ...
            cout<<"Karnet wa¿ny od godziny: "<<g1.dane_od<<" do godziny: "<< g1.dane_do<<endl;
		...
		else if( rodzaj_karnetu == "calodniowy")
		{
            ...
            cout<<endl<<"Karnet ca³odniowy zostal zakupiony!"<<endl;
            cout<<"Karnet wa¿ny od godziny: "<<c1.dane_od<<" do godziny: "<<c1.dane_do<<endl;
            cout<<"Czyli wa¿ny przez: "<<c1.czas<<" godzin."<<endl;
		...
		else if( rodzaj_karnetu == "nocny")
		{
            ...
            cout<<"Karnet wa¿ny od godziny : "<<n1.dane_od<<" do godziny: "<<n1.dane_do<<endl;
            cout<<"Czyli wa¿ny przez: "<<n1.czas<<" godziny."<<endl;
		...
		{
			cout<<endl<<"Karnet popo³udniowy zostal zakupiony!"<<endl;
            ...
            cout<<"Karnet wa¿ny od godziny : "<<p1.dane_od<<" do godziny: "<<p1.dane_do<<endl;
            cout<<"Czyli wa¿ny przez: "<<p1.czas<<" godzin."<<endl;
		...
		else if( rodzaj_karnetu == "dzienny")
		{
            ...
            cout<<endl<<"Karnet wa¿ny od godziny : "<<d1.dane_od<<" do godziny: "<<d1.dane_do<<endl;
            cout<<"Czyli wa¿ny przez: "<<d1.czas<<" godzin."<<endl;
		...
		cout<<endl<<"            ZYCZYMY UDANEJ ZABAWY !!!         "<<endl;
    }
...
class Sprzet
{
	...
	void pokaz_stan()
	{
		...
		void wypozyczenie()
		{
			...
			wypozycz:
			cout<<endl<<"******* JAKI SPRZÊT CHCESZ WYPO¯YCZYÆ ? *******"<<endl;
			cout<<"****************** 1. Narty *******************"<<endl;
		...
		{
			oddaj:
			cout<<endl<<"********* JAKI SPRZÊT CHCESZ ODDAÆ ? **********"<<endl;
			cout<<"****************** 1. Narty *******************"<<endl;
			cout<<"**************** 2. Snowboard *****************"<<endl;
			cout<<"************ 3. Buty Narciarskie **************"<<endl;
			cout<<"************ 4. Buty Snowboardowe *************"<<endl;
